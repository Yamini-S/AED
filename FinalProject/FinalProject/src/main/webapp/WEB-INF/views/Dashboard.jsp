			...
			<div class="container">
				<div class="row">
					<div class="logo col-md-4 ">
						<h1>
							<a href="">CouplesCorner<span class="red"> welcomes
									${coupleSU.coupleName}</span>
					...
					<div class="row">
						...
						<div class="col-sm-9" contenteditable="false" style="">
							...
							<div class="panel panel-default">
								...
								<div align="left">
								<i class="fa fa-map-marker "></i><input type="text" class="form-control curr-loc" placeholder="Enter Current Location" id="searchbox" name="location"
										 >  </div>
