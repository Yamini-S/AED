...
public class HomeController {
	...
	public String loginCheck(Model model, @Validated CoupleSignUp csu, BindingResult result, HttpServletRequest request, HttpServletResponse response ){
		...
		//		} else {
		//			try {
		//				CoupleSignUp coupleSU = csuDAO.checkLogin(csu.getCoupleName(), csu.getPassword());
		//				if(coupleSU != null){
		//
		//					// Creating a cookies here
		//					//					if(csu.getRemember() !=null){
		//					//						coupleSignUpDAO.createCookies(csu, request, response, csu.getRemember());
		//					//					}
		...
		//
		//					CoupleInfo coupleInfo1 = csuDAO.getUserData(csu.getCoupleName());
		//					if(coupleInfo1 == null){
		//						return "Dashboard";
		//					} else {
		//
		...
		//					}
		//				} else {
		//					// this is to show error when not able to find the user account
		//
