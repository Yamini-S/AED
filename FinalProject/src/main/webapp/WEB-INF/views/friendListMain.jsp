						...
						<div class="panel-body">
							<ul class="nav nav-tabs nav-justified ">
								<li class="active "><a href="#friendList" data-toggle="tab" id = "friend-all-page"><strong
										class="text-primary">Friends</strong> <span class="badge">${counterAllAccepted}</span></a>
								</li>
								<li class=""><a href="#friendRequest" data-toggle="tab" id="friend-request-page"><strong
										...
										class="badge">${friendRequestCount} </span></a></li>
								<li class=""><a href="#pendingRequest" data-toggle="tab" id="friend-pending-page"><strong
										...
										class="badge">${pendingReqCount}</span></a>
							</ul>
															...
															<div class="caption">
																...
																<small><b>Couple Info: </b><span
																	class="coupleName couple-info"> <span
																		class="person1-age"> p1Age</span> years old <span
																		class="person1-sex"> Male</span> <span class="&">
																			& </span> <span class="person2-age"> p1Age</span> years old
																		<span class="person2-sex"> Female</span>
																		...
																		class="username story">We are looking for.... </span></small>
															</div>
														</div>
													</li>
												</c:forEach>
